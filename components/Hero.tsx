  ...
  return (
    <div className='mx-2 bg-black-700 relative flex flex-col'>
        ...
        <div className="absolute bg-slate-900 z-10 px-10 py-5 rounded-md top-[50%] left-[45%]" >
            <h1 className='text-2xl text-white mb-5 md:text-4xl'>Why buying a new one</h1>
            <h1 className='text-3xl text-yellow-500 md:text-5xl '>When we can fix your old one.</h1>
        </div>
    </div>
  )
}
